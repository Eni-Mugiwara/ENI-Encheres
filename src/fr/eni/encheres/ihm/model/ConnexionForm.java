...
public interface ConnexionForm {
	...
	static final String REGEXGENERAL = "^[\\w\\s�������-]{3,}$";
	 ...
	 * 			la liste doit suivre le m�me ordre que celui du constructeur Utilisateur
	 * 
	...
	public static ArrayList<String> checkForm(HttpServletRequest request, ArrayList<String> entries) {
		...
		for (String entry : entries) {
			...
			case "mdp":
				...
				// v�rifie si une �rreur est lev�, si oui break
	 ...
	 * 
	 * @Param : String, Mot de passe entr� par l'utilisateur
	 * 
	 * @Return : String, Mot de passe hash�
	 */
